#define EXTENSION_NAME LogCatExt
#define LIB_NAME "LogCat"
#define MODULE_NAME "logcat"
...
DM_DECLARE_EXTENSION(EXTENSION_NAME, LIB_NAME, dmLogCat::AppInitializeApp, dmLogCat::AppFinalizeApp, dmLogCat::InitializeApp, dmLogCat::UpdateApp, dmLogCat::OnEventApp, dmLogCat::FinalizeApp)

#else

static dmExtension::Result InitializeApp(dmExtension::Params *params)
{
    dmLogInfo("Registered extension LogCat (null)");
    return dmExtension::RESULT_OK;
}
